...
public class HbmRun {
     ...
     * Это один из способов избежать проблему (LazyInitializationException). Проблема связана с попыткой получить
     * доступ к вложенному объекту вне текущей сессии, с которой ассоциирован этот объект, и поэтому за пределами
     * сессии он уже становится недоступен.
     * @param args
     */
